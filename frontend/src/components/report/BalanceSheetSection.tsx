...
export const BalanceSheetSection: React.FC<Props> = ({ years }) => {
  ...
  const activos = [
    { label: 'A) ACTIVO FIJO', key: 'nonCurrentAssets', isBold: true, isTotal: true, bgClass: 'bg-blue-100' },
    { label: 'Activo Fijo - Depreciación Acumulada', key: 'tangibleAssets', indent: 1 },
    { label: 'Otros Activos', key: 'intangibleAssets', indent: 1 },
    { label: 'Inversiones financieras LP', key: 'financialInvestmentsLp', indent: 1 },
    { label: 'B) ACTIVO CIRCULANTE', key: 'currentAssets', isBold: true, isTotal: true, bgClass: 'bg-green-100' },
  ...
  const pasivos = [
    ...
    { label: 'B) PASIVO NO CIRCULANTE', key: 'nonCurrentLiabilities', isBold: true, isTotal: true, bgClass: 'bg-orange-100' },
    ...
    { label: 'C) PASIVO CIRCULANTE', key: 'currentLiabilities', isBold: true, isTotal: true, bgClass: 'bg-red-100' },
